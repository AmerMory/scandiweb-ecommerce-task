...
export default function Card({ product, click, selectedCategory, selectedCurrency, amount, handleSelectedProductDetails,selectedProductDetails, setSelectedProductDetails }) {
